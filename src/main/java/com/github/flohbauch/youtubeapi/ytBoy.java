        ...
        while (iteratorSearchResults.hasNext()) {
            ...
            if (rId.getKind().equals("youtube#video")) {
               ...
               /* System.out.println(" Video Id" + rId.getVideoId());
                ...
                System.out.println("\n-------------------------------------------------------------\n");*/
               out ="https://www.youtube.com/watch?v="+ rId.getVideoId();
            }
        }
        return out;
    }

    private long getResultNum() {
        return NUMBER_OF_VIDEOS_RETURNED;
    }

    private YouTube youtube;

    public String getVidUrl(String keyword) {
    String url = "";
        try {
            ...
            String apiKey = ConfigGetter.settings("googleapi");
            ...
            search.setMaxResults(getResultNum());

            // Call the API and print results.
            SearchListResponse searchResponse = search.execute();
            List<SearchResult> searchResultList = searchResponse.getItems();
            if (searchResultList != null) {
                url = prettyPrint(searchResultList.iterator(), queryTerm);
            }
